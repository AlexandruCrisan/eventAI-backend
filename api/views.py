...
from api.serializers import JourneySerializer, JourneyGenerateSerializer, JourneyGenerateResponseSerializer
...
class JourneyGenerateAPIView(APIView):
    def generate_journey(self, data: dict):
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            generated_journey_json = self.generate_journey(serializer.validated_data)
